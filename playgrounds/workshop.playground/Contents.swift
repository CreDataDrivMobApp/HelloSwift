...
/*: Amongst many others, structs and classes are the most common ways to structure your data
 - Note: structs are value types and classes are reference types
 */
